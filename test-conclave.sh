...
python3 "$CONCLAVE" --project-dir "$PROJECT" --mode verification --machine-json --no-synthesis --no-sync --prompt "Smoke test. Return verification checks for the conclave setup."
python3 "$ROOT/codex-skill/external-advisor/scripts/validate_conclave.py" --project-dir "$PROJECT"
